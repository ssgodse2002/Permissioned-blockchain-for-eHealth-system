       ...
       <div class="sidebar-wrapper">
        <ul class="nav">
         <!--  <li class="nav-item active  ">
          ...
          <li class="nav-item active ">
            <a class="nav-link" style="background-color: #4169e1" href="H_ShowPatient.jsp">
            ...
            <div class="col-md-12">
              <div class="card" style="background-color:black;">
                <div class="card-header" style="background-color: #4169e1">
                  <h4 class="card-title " style="color: white;">Info Patient</h4>
...
<input type="text" name="txtpname" value="<%=rs.getString(3)%>" readonly="readonly" style="width: 80%" />
									...
									<input type="submit" name="submit" class="btn btn-primary pull-left" value="Next" style="background-color: #4169e1">
										</td>
										</tr>
