  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item  ">
            <a class="nav-link" href="InsuranceProfile.jsp" style="background-color: #4169e1">
              <i class="material-icons">dashboard</i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item active ">
            <a class="nav-link" href="InsuranceDetails.jsp" style="background-color: #4169e1">
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-header" style="background-color: #4169e1"><!-- change -->
									<h4 class="card-title" style="color: white;">Insurance Details</h4><!-- change -->
									<p class="card-category" style="color: white;"></p><!-- change -->
								</div>
                ...
                <div class="card-body">
                 ...
                 <input type="submit" name="submit" class="btn btn-primary pull-right" style="background-color: #4169e1" value="Save">
