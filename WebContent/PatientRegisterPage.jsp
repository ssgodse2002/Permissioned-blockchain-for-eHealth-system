...
<body style="background-image: url('bg1.jpg');">
	...
	<header id="home" class="gradient-violat">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav  navbar-right">
						...
						<li class="active"><a style="color: white;"
							href="PatientRegisterPage.jsp">Patient Register</a></li><!--change  -->
					</ul>
				</div>
				<!-- /.navbar-collapse -->
		...
		<div class="w3lsfooteragileits" style="height: 50%; padding-top: 4%">
			<h2>High Dimensional Health Care Privacy Approach using
				...
				<form action="Registration" method="post">
					<div id="login" class="animate w3layouts agileits form">
						<div class="ferry ferry-from">
							<input type="hidden" value="Patient" name="roll">

						</div>
						<div class="ferry ferry-from">
							<label>Select Hospital Name:</label> <select name="hospital_name"
								required>
						...
						<div class="ferry ferry-from">
							...
							&nbsp; <input type="text" name="txtname"
								placeholder="Name" required="required" style="width: 100%; height: 15%">
						</div>
						&nbsp;
						<div class="ferry ferry-from">
						...
						<div class="ferry ferry-from">
							...
							&nbsp;
							 <input type="text" name="txtmobile"
								pattern="[7-9]{1}[0-9]{9}" maxlength="10" placeholder="Enter Mobile Number"
								maxlength="10" required="required" style="width: 100%; height: 15%">
						</div>
						<div class="ferry ferry-from">
							...
							&nbsp;
							 <input type="password"
								...
								style="width: 100%; height: 15%" name="txtpwd"
								required="required">
						</div>
						&nbsp;
						<div class="ferry ferry-from">
							...
							<input type="text" id="message"
								...
								title="Please enter Address" required="required" style="width: 100%; height: 15%">
						</div>
