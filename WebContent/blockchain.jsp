       ...
       <div class="sidebar-wrapper">
        <ul class="nav">
         <!--  <li class="nav-item active  ">
          ...
          <li class="nav-item active">
            <a class="nav-link" style="background-color: #4169e1" href="showblockchain.jsp">
            ...
            <div class="col-md-12">
              <div class="card" style="background-color: black;">
                <div class="card-header" style="background-color: #4169e1">
                  <h4 class="card-title " style="color: white;">Info Block Chain</h4>
